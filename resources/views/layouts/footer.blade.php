            ...
            <div class="row footer-widget-wrapper">
                <div class="col-lg-4 col-md-6 col-sm-6 footer-widget">
                    <div class="footer-widget__logo mb-30">
                        <img src="{{ asset('assets/images/logo/dark-logo-160x48.webp') }}" width="160"
                            height="48" class="img-fluid" alt="">
                    </div>
                    <ul class="footer-widget__list">
                        <li>58 Howard Street #2 San Francisco, CA 941</li>
                        <li><a href="mailto:contact@aeroland.com"
                                class="hover-style-link">contact@aeroland.com</a></li>
                ...
                <div class="col-lg-2 col-md-4 col-sm-6 footer-widget">
                    ...
                    <ul class="footer-widget__list">
                        <li><a href="#" class="image_btn"><img class="img-fluid"
                                    src="{{ asset('assets/images/icons/aeroland-button-google-play.webp') }}"
                                    alt=""></a></li>
                        <li><a href="#" class="image_btn"><img class="img-fluid"
                                    src="{{ asset('assets/images/icons/aeroland-button-app-store.webp') }}"
                                    alt=""></a></li>
                    </ul>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 text-center text-md-start">
                    <span class="copyright-text">&copy; 2021 Mitech. <a href="https://hasthemes.com/">All
